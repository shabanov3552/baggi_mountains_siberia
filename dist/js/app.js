...
"use strict";
export const modules_flsModules = {};
function isWebp() {
...
function initSliders() {
	...
	if (document.querySelector(".technique__slider")) new core(".technique__slider", {
		modules: [Navigation],
		observer: true,
		observeParents: true,
		slidesPerView: 4,
...
class E {
	...
	loadAjaxContent(t) {
		...
		}, i.open("GET", t.src), i.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
			i.send(t.ajax || null), t.xhr = i;
	}
	loadIframeContent(t) {
...
function animationTourCard(e) {
	...
	if ("mouseenter" === type) targetImg.classList.add("hover-anim");
	if ("mouseleave" === type) targetImg.classList.remove("hover-anim");
}
let tourCalculator = {
	adults: 1,
	children: 0,
